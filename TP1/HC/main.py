...
print('Entre com os limites desejados:')
...
for i in range(30):
    melhor_solucao, melhor_funcaoObj = HC.hillClimbing(max_iter, inferior, superior, tam_passo, valor)
